      ...
      >
        ...
        >
          <p class="text-center text-sm sm:text-base text-gray-600 mb-6 flex-shrink-0">
            {{ isPaused ? 'Вы уверены, что хотите возобновить этот сеанс?' : 'Вы уверены, что хотите поставить этот сеанс на паузу?' }}
          </p>
          <div class="flex justify-center gap-3 mt-auto">
            ...
            <button
              @click="$emit('confirm')"
              class="px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm rounded-lg border border-yellow-200 bg-yellow-200 text-gray-600 hover:bg-yellow-300"
            >
