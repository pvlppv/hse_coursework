<template>
  <div class="container mx-auto flex justify-center">
    <div class="max-w-lg w-full space-y-5">
      <h1 class="text-lg sm:text-xl font-semibold text-center">Статистика</h1>
...
import { useFetch, useScrollToTop } from '../composables/utils.js';
...
const healthCategories = ref([
  { key: 'steps', label: 'Шаги (шт)', colors: ['#f3f4f6', '#f3f4f6', '#bbf7d0', '#86efac', '#4ade80', '#22c55e', '#15803d'], max: 20000 },
  { key: 'energy', label: 'Энергия (ккал)', colors: ['#f3f4f6', '#f3f4f6', '#bbf7d0', '#86efac', '#4ade80', '#22c55e', '#15803d'], max: 1000 },
  { key: 'water', label: 'Вода (мл)', colors: ['#f3f4f6', '#f3f4f6', '#bbf7d0', '#86efac', '#4ade80', '#22c55e', '#15803d'], max: 2500 },
  { key: 'sleep', label: 'Сон (ч)', colors: ['#f3f4f6', '#f3f4f6', '#bbf7d0', '#86efac', '#4ade80', '#22c55e', '#15803d'], max: 9 },
]);
